  ...
  .shift-password
    form.shift-password__form(@submit.prevent="submitHandler")
      .form__block
        ...
        password-field(id="shift-password" v-model="password" :v="$v.password" info registration :class="{checked: $v.password.required && $v.passwordTwo.sameAsPassword && $v.password.minLength}")
        password-repeat-field(id="shift-repeat-password" v-model="passwordTwo" :v="$v.passwordTwo" :class="{checked: $v.password.required && $v.passwordTwo.sameAsPassword && $v.passwordTwo.minLength}")
      .form__block
